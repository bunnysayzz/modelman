...
class _$ChatMessageImpl implements _ChatMessage {
  ...
  @override
  String toString() {
    return 'ChatMessage(id: $id, role: $role, content: $content, timestamp: $timestamp, toolName: $toolName, toolResult: $toolResult, isStreaming: $isStreaming)';
  }
    ...
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            const DeepCollectionEquality()
                .equals(other._toolResult, _toolResult) &&
  ...
  int get hashCode => Object.hash(runtimeType, id, role, content, timestamp,
      toolName, const DeepCollectionEquality().hash(_toolResult), isStreaming);

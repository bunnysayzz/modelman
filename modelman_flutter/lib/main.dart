    ...
    () async {
      ...
      runApp(
        ProviderScope(
          ...
          child: ModelmanApp(initialThemeName: savedThemeName),
        ),
      );
    },
    (error, stack) {
...
/// on first build.
class ModelmanApp extends ConsumerStatefulWidget {
  final String? initialThemeName;

  const ModelmanApp({super.key, this.initialThemeName});

  @override
  ConsumerState<ModelmanApp> createState() => _ModelmanAppState();
}

class _ModelmanAppState extends ConsumerState<ModelmanApp> {
  @override
  void initState() {
    super.initState();
    // Restore saved theme
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp.router(
      title: 'Modelman — MCP Testing Tool',
